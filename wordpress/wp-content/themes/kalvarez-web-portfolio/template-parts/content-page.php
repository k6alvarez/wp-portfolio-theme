		...
		<div class="content feature-work">
			<div class="container">
				...
				<div class="thumbnail">					
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/penguins.jpg" alt=""></a>	
				</div>
				<div class="thumbnail">					
					<div class="more-info">
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/black-21.jpg" alt=""></a>					
				</div>
				<div class="thumbnail last">					
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/makeup-artist.jpg" alt=""></a>
				</div>
				<div class="thumbnail">					
					<div class="more-info">
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/cherrybomb.jpg" alt=""></a>
				</div>		
				<div class="thumbnail ">					
					<div class="more-info">
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/trane-mobile.jpg" alt=""></a>
				</div>				
				...
				<div class="thumbnail last">					
					...
					<a class="trigger" href="#"><img src="http://localhost:8888/wp-content/uploads/2015/09/truckerapp.jpg" alt=""></a>
				</div>				
			</div>
		</div>
	<?php endif; ?>
